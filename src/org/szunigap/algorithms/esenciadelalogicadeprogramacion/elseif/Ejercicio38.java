/*
    ...
    Descripción: Leer tres números enteros y determinar si el último dígito de los tres números
                 es igual
    Fecha:      10/08/22
 */
    ...
    public static void main(String[] args) {
        ...
        if ( (num1 >= 10 && num1 <= 99) && (num2 >= 10 && num2 <= 99) && (num3 >= 10 && num3 <= 99)){
           ...
           // int numero1Digito1 = num1 / 10;
            ...
            if ( numero1Digito2 == numero2Digito2 && numero2Digito2 == numero3Digito2){
                System.out.println("El último dígito de los tres números es igual");
            } else {
                System.out.println("El último dígito de los tres números son diferentes");
            }
            ...
            if((numero1Digito3 == numero2Digito3) && (numero3Digito3 == numero1Digito3)) {
                System.out.println("Los últimos dígitos de los números son iguales...");
            } else {
                System.out.println("Los últimos dígitos de los números son diferentes");
            }
            ...
            if((numero1Digito4 == numero2Digito4) && (numero3Digito4 == numero1Digito4)) {
                System.out.println("Los últimos dígitos de algunos números son iguales...");
            } else {
                System.out.println("Los últimos dígitos de los números son diferentes");
            }
