...
/*
    ...
    Descripción: Desarrollar un programa que permita leer 10 números enteros y determinar en qué
                    pocisión entró el número mayor y si el objetivo hubiera sido determinar si el número
                    mayor de 10 números leidos es par
    Fecha: JUunio 23
 */
public class Ejemplo3 {
    public static void main(String[] args) {
        ...
        if (aux % 2 == 0) { //aux / 2 *2 = aux
            System.out.println("El número mayor es, " + aux + " y es par");
        } else {
            System.out.println("El número mayor es igual a " + aux + " y no es par");
        }
    }
}
